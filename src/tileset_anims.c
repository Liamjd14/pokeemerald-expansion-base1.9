...
static void TilesetAnim_es_General(u16); //Custom
static void TilesetAnim_frp_general(u16); //FRLG
...
static void QueueAnimTiles_es_General_Flower(u16); //Custom
static void QueueAnimTiles_General_Flower_FRLG(u16); //FRLG
static void QueueAnimTiles_General_Water_Current_LandWatersEdge(u16);//FRLG
static void QueueAnimTiles_General_SandWatersEdge(u16);//FRLG
static void QueueAnimTiles_General_Water(u16);
static void QueueAnimTiles_General_SandWaterEdge(u16);
static void QueueAnimTiles_General_Waterfall(u16);
static void QueueAnimTiles_General_LandWaterEdge(u16);
static void QueueAnimTiles_General_Water(u16); //Custom
static void QueueAnimTiles_es_General_SandWaterEdge(u16); //Custom
static void QueueAnimTiles_es_General_Waterfall(u16); //Custom
static void QueueAnimTiles_es_General_LandWaterEdge(u16); //Custom
static void QueueAnimTiles_es_Building_TVTurnedOn(u16);
...
//--------------------------------------------------------------------------------------------------------------------------------------
// Custom General
const u16 gTilesetAnims_es_General_Flower_Frame1[] = INCBIN_U16("data/tilesets/primary/es_general/anim/flower/1.4bpp");
const u16 gTilesetAnims_es_General_Flower_Frame0[] = INCBIN_U16("data/tilesets/primary/es_general/anim/flower/0.4bpp");
const u16 gTilesetAnims_es_General_Flower_Frame2[] = INCBIN_U16("data/tilesets/primary/es_general/anim/flower/2.4bpp");

const u16 *const gTilesetAnims_es_General_Flower[] = {
    gTilesetAnims_es_General_Flower_Frame0,
    gTilesetAnims_es_General_Flower_Frame1,
    gTilesetAnims_es_General_Flower_Frame0,
    gTilesetAnims_es_General_Flower_Frame2
};

const u16 gTilesetAnims_es_General_Water_Frame0[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/0.4bpp");
const u16 gTilesetAnims_es_General_Water_Frame1[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/1.4bpp");
const u16 gTilesetAnims_es_General_Water_Frame2[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/2.4bpp");
const u16 gTilesetAnims_es_General_Water_Frame3[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/3.4bpp");
const u16 gTilesetAnims_es_General_Water_Frame4[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/4.4bpp");
const u16 gTilesetAnims_es_General_Water_Frame5[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/5.4bpp");
const u16 gTilesetAnims_es_General_Water_Frame6[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/6.4bpp");
const u16 gTilesetAnims_es_General_Water_Frame7[] = INCBIN_U16("data/tilesets/primary/es_general/anim/water/7.4bpp");

const u16 *const gTilesetAnims_es_General_Water[] = {
    gTilesetAnims_es_General_Water_Frame0,
    gTilesetAnims_es_General_Water_Frame1,
    gTilesetAnims_es_General_Water_Frame2,
    gTilesetAnims_es_General_Water_Frame3,
    gTilesetAnims_es_General_Water_Frame4,
    gTilesetAnims_es_General_Water_Frame5,
    gTilesetAnims_es_General_Water_Frame6,
    gTilesetAnims_es_General_Water_Frame7
};

const u16 gTilesetAnims_es_General_SandWaterEdge_Frame0[] = INCBIN_U16("data/tilesets/primary/es_general/anim/sand_water_edge/0.4bpp");
const u16 gTilesetAnims_es_General_SandWaterEdge_Frame1[] = INCBIN_U16("data/tilesets/primary/es_general/anim/sand_water_edge/1.4bpp");
const u16 gTilesetAnims_es_General_SandWaterEdge_Frame2[] = INCBIN_U16("data/tilesets/primary/es_general/anim/sand_water_edge/2.4bpp");
const u16 gTilesetAnims_es_General_SandWaterEdge_Frame3[] = INCBIN_U16("data/tilesets/primary/es_general/anim/sand_water_edge/3.4bpp");
const u16 gTilesetAnims_es_General_SandWaterEdge_Frame4[] = INCBIN_U16("data/tilesets/primary/es_general/anim/sand_water_edge/4.4bpp");
const u16 gTilesetAnims_es_General_SandWaterEdge_Frame5[] = INCBIN_U16("data/tilesets/primary/es_general/anim/sand_water_edge/5.4bpp");
const u16 gTilesetAnims_es_General_SandWaterEdge_Frame6[] = INCBIN_U16("data/tilesets/primary/es_general/anim/sand_water_edge/6.4bpp");

const u16 *const gTilesetAnims_es_General_SandWaterEdge[] = {
    gTilesetAnims_es_General_SandWaterEdge_Frame0,
    gTilesetAnims_es_General_SandWaterEdge_Frame1,
    gTilesetAnims_es_General_SandWaterEdge_Frame2,
    gTilesetAnims_es_General_SandWaterEdge_Frame3,
    gTilesetAnims_es_General_SandWaterEdge_Frame4,
    gTilesetAnims_es_General_SandWaterEdge_Frame5,
    gTilesetAnims_es_General_SandWaterEdge_Frame6,
    gTilesetAnims_es_General_SandWaterEdge_Frame0
};

const u16 gTilesetAnims_es_General_Waterfall_Frame0[] = INCBIN_U16("data/tilesets/primary/es_general/anim/waterfall/0.4bpp");
const u16 gTilesetAnims_es_General_Waterfall_Frame1[] = INCBIN_U16("data/tilesets/primary/es_general/anim/waterfall/1.4bpp");
const u16 gTilesetAnims_es_General_Waterfall_Frame2[] = INCBIN_U16("data/tilesets/primary/es_general/anim/waterfall/2.4bpp");
const u16 gTilesetAnims_es_General_Waterfall_Frame3[] = INCBIN_U16("data/tilesets/primary/es_general/anim/waterfall/3.4bpp");

const u16 *const gTilesetAnims_es_General_Waterfall[] = {
    gTilesetAnims_es_General_Waterfall_Frame0,
    gTilesetAnims_es_General_Waterfall_Frame1,
    gTilesetAnims_es_General_Waterfall_Frame2,
    gTilesetAnims_es_General_Waterfall_Frame3
};

const u16 gTilesetAnims_es_General_LandWaterEdge_Frame0[] = INCBIN_U16("data/tilesets/primary/es_general/anim/land_water_edge/0.4bpp");
const u16 gTilesetAnims_es_General_LandWaterEdge_Frame1[] = INCBIN_U16("data/tilesets/primary/es_general/anim/land_water_edge/1.4bpp");
const u16 gTilesetAnims_es_General_LandWaterEdge_Frame2[] = INCBIN_U16("data/tilesets/primary/es_general/anim/land_water_edge/2.4bpp");
const u16 gTilesetAnims_es_General_LandWaterEdge_Frame3[] = INCBIN_U16("data/tilesets/primary/es_general/anim/land_water_edge/3.4bpp");

const u16 *const gTilesetAnims_es_General_LandWaterEdge[] = {
    gTilesetAnims_es_General_LandWaterEdge_Frame0,
    gTilesetAnims_es_General_LandWaterEdge_Frame1,
    gTilesetAnims_es_General_LandWaterEdge_Frame2,
    gTilesetAnims_es_General_LandWaterEdge_Frame3
};
//--------------------------------------------------------------------------------------------------------------------------------------
...
void InitTilesetAnim_es_General(void)
{
    sPrimaryTilesetAnimCounter = 0;
    sPrimaryTilesetAnimCounterMax = 256;
    sPrimaryTilesetAnimCallback = TilesetAnim_es_General;
}
//-----------------------------------------------------------------------------------------------------
...
static void TilesetAnim_es_General(u16 timer)
{
    if (timer % 16 == 0)
        QueueAnimTiles_es_General_Flower(timer / 16);
    if (timer % 16 == 1)
        QueueAnimTiles_es_General_Water(timer / 16);
    if (timer % 16 == 2)
        QueueAnimTiles_es_General_SandWaterEdge(timer / 16);
    if (timer % 16 == 3)
        QueueAnimTiles_es_General_Waterfall(timer / 16);
    if (timer % 16 == 4)
        QueueAnimTiles_es_General_LandWaterEdge(timer / 16);
}
//------------------------------------------------------------------------------------------------------------------------------
...
void InitTilesetAnim_frp_general(void)
{
    sPrimaryTilesetAnimCounter = 0;
    sPrimaryTilesetAnimCounterMax = 256;
    sPrimaryTilesetAnimCallback = TilesetAnim_frp_general;
}

// palette: general 00
static const u16 sTilesetAnims_General_Flower_Frame0[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/flower/0.4bpp");
static const u16 sTilesetAnims_General_Flower_Frame1[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/flower/1.4bpp");
static const u16 sTilesetAnims_General_Flower_Frame2[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/flower/2.4bpp");
static const u16 sTilesetAnims_General_Flower_Frame3[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/flower/3.4bpp");
static const u16 sTilesetAnims_General_Flower_Frame4[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/flower/4.4bpp");
...
// palette: general 04
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame0[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/0.4bpp");
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame1[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/1.4bpp");
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame2[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/2.4bpp");
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame3[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/3.4bpp");
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame4[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/4.4bpp");
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame5[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/5.4bpp");
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame6[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/6.4bpp");
static const u16 sTilesetAnims_General_Water_Current_LandWatersEdge_Frame7[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/water_current_landwatersedge/7.4bpp");
...
// palette: general 04
static const u16 sTilesetAnims_General_SandWatersEdge_Frame0[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/0.4bpp");
static const u16 sTilesetAnims_General_SandWatersEdge_Frame1[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/1.4bpp");
static const u16 sTilesetAnims_General_SandWatersEdge_Frame2[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/2.4bpp");
static const u16 sTilesetAnims_General_SandWatersEdge_Frame3[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/3.4bpp");
static const u16 sTilesetAnims_General_SandWatersEdge_Frame4[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/4.4bpp");
static const u16 sTilesetAnims_General_SandWatersEdge_Frame5[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/5.4bpp");
static const u16 sTilesetAnims_General_SandWatersEdge_Frame6[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/6.4bpp");
static const u16 sTilesetAnims_General_SandWatersEdge_Frame7[] = INCBIN_U16("data/tilesets/primary/frp_general/anim/sandwatersedge/7.4bpp");
...
static void QueueAnimTiles_General_Flower_FRLG(u16 timer)
{
...
static void TilesetAnim_frp_general(u16 timer)
{
    if (timer % 8 == 0)
    ...
    if (timer % 16 == 2)
        QueueAnimTiles_General_Flower_FRLG(timer >> 4);
}
...
static void QueueAnimTiles_es_General_Flower(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_es_General_Flower);
    AppendTilesetAnimToBuffer(gTilesetAnims_es_General_Flower[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(508)), 4 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_es_General_Water(u16 timer)
{
    u8 i = timer % ARRAY_COUNT(gTilesetAnims_es_General_Water);
    AppendTilesetAnimToBuffer(gTilesetAnims_es_General_Water[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(432)), 30 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_es_General_SandWaterEdge(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_es_General_SandWaterEdge);
    AppendTilesetAnimToBuffer(gTilesetAnims_es_General_SandWaterEdge[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(464)), 10 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_es_General_Waterfall(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_es_General_Waterfall);
    AppendTilesetAnimToBuffer(gTilesetAnims_es_General_Waterfall[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(496)), 6 * TILE_SIZE_4BPP);
}
//---------------------------------------------------------------------------------------------------------------------------------------
...
static void QueueAnimTiles_es_General_LandWaterEdge(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_es_General_LandWaterEdge);
    AppendTilesetAnimToBuffer(gTilesetAnims_es_General_LandWaterEdge[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(480)), 10 * TILE_SIZE_4BPP);
}
//-------------------------------------------------------------------------------------------------------------------------------------------------
