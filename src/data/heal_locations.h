static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_A2_T_ES_MAYCASTLE - 1] = {MAP_GROUP(A2_T_ES_MAYCASTLE), MAP_NUM(A2_T_ES_MAYCASTLE), 10, 10},
    ...
    [HEAL_LOCATION_A2_T_ES_OCEANVIEW - 1] = {MAP_GROUP(A2_T_ES_OCEANVIEW), MAP_NUM(A2_T_ES_OCEANVIEW), 29, 12},
    [HEAL_LOCATION_A2_T_ES_PROFESSORS_HOUSE - 1] = {MAP_GROUP(A2_T_ES_PROFESSORS_HOUSE), MAP_NUM(A2_T_ES_PROFESSORS_HOUSE), 55, 9},
    [HEAL_LOCATION_A2_T_ES_JEWELBANK - 1] = {MAP_GROUP(A2_T_ES_JEWELBANK), MAP_NUM(A2_T_ES_JEWELBANK), 49, 9},
    [HEAL_LOCATION_A2_L_ES_LILYFLOWER_LAKE - 1] = {MAP_GROUP(A2_L_ES_LILYFLOWER_LAKE), MAP_NUM(A2_L_ES_LILYFLOWER_LAKE), 51, 21},
};
