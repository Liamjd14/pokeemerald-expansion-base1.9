...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_OCEANVIEW] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PROFESSORS_LAB] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_JEWLBANK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MAYCASTLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WILDERNESS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LILYFLOWER_LAKE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ESROUTE_1] = MAPPOPUP_THEME_WOOD,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_OCEANVIEW] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PROFESSORS_LAB] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_JEWLBANK] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MAYCASTLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_WILDERNESS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LILYFLOWER_LAKE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ESROUTE_1] = MAPPOPUP_THEME_BW_DEFAULT,
};
