...
#define MAPSEC_OCEANVIEW                    0xD5
#define MAPSEC_PROFESSORS_LAB               0xD6
#define MAPSEC_JEWLBANK                     0xD7
#define MAPSEC_MAYCASTLE                    0xD8
#define MAPSEC_WILDERNESS                   0xD9
#define MAPSEC_LILYFLOWER_LAKE              0xDA
#define MAPSEC_ESROUTE_1                    0xDB
